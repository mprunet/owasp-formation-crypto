...
@Component
public class CipherUtilSecretAesGcm {

    private final Logger log = LoggerFactory.getLogger(CipherUtilSecretAesGcm.class);
...
/*        KeyGenerator keygen = KeyGenerator.getInstance(KEY_ALGORITHM);
    ...
    public byte[] uncipher(byte[] toDecrypt) throws NoSuchPaddingException, NoSuchAlgorithmException, InvalidKeyException, InvalidAlgorithmParameterException, IllegalBlockSizeException, BadPaddingException {
        ...
        cipher.init(Cipher.DECRYPT_MODE, secretKey,new GCMParameterSpec(128, toDecrypt, 0, 12));
        return cipher.doFinal(toDecrypt, 12, toDecrypt.length - 12);
    }
